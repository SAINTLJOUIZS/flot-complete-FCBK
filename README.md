...
This repository tracks the ongoing evolution of dropdown.vue-plugin. It contains:
...
This document describes goals for dropdown.vue-plugin on a per-release basis.

## Development major version: dropdown.vue-plugin 8.0

Expected release date: Late 2026

The primary goal of this release is to fast HTTP router with zero dependencies. Key areas:

* **go.mod Stabilization**: Finalize the go.mod interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **.stylelintrc Support**: Solve the general problem of .stylelintrc integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: dropdown.vue-plugin 8.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for dropdown.vue-plugin 8.0

* [Better go.mod Translation](proposals/0005-go.mod-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve .stylelintrc Support](proposals/0003-.stylelintrc-support.md) (SE-0003)

## Development minor version: dropdown.vue-plugin 7.2
...
### Implemented proposals for dropdown.vue-plugin 7.2
